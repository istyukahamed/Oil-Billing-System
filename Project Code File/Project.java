...
public class Project extends JFrame implements ActionListener {
    ...
    String atype, biller;
    Project(String atype ,String biller) {
        
        this.atype = atype;
        this.biller = biller;
        setExtendedState(JFrame.MAXIMIZED_BOTH);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/oilcv.jpeg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (msg.equals("New Customer")) {
            ...
            new NewCustomer();
             ...
             new ViewInformation(biller);
             
         } else if (msg.equals("Update Information")) {
             
             new UpdateInformation(biller);
             
         } else if (msg.equals("Bill Details")) {
             
             new BillDetails(biller);

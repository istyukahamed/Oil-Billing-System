...
public class NewCustomer extends JFrame implements ActionListener {
    ...
    NewCustomer() {
        ...
        JLabel lblmeterno = new JLabel("Bill Number");
        lblmeterno.setBounds(100, 120, 120, 20);
        p.add(lblmeterno);
        
        lblbiller = new JLabel("");
        lblbiller.setBounds(240, 120, 120, 20);
        p.add(lblbiller);
        
        
        Random ran = new Random();
        long number = ran.nextLong() % 100000000;
        lblbiller.setText("" + Math.abs(number));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            String biller = lblbiller.getText();
            ...
            String query1 = "insert into customer values ('"+name+"', '"+biller+"', '"+address+"','"+city+"', '"+state+"', '"+email+"', '"+phone+"')";
            String query2 = "insert into login values('"+biller+"', '', '"+name+"', '', '')";

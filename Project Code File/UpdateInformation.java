...
public class UpdateInformation extends JFrame implements ActionListener {
    ...
    UpdateInformation(String biller) {
        ...
        JLabel heading = new JLabel("Update Coustomer Information");
        ...
        lblbillnumber.setBounds(30, 110, 100, 20);
        add(lblbillnumber);
        
        JLabel billnumber  = new JLabel("");
        billnumber.setBounds(230, 110, 200, 20);
        add(billnumber);
        ...
        try {
            ...
            while(rs.next()) {
                ...
                billnumber.setText(rs.getString("bill_no"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            Conn c = new Conn();
             ...
             c.s.executeUpdate("update customer set address = '"+address+"', city = '"+city+"', state = '"+state+"', email = '"+email+"', phone = '"+phone+"' where bill_no = '"+biller+"'");

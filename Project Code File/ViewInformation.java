...
public class ViewInformation extends JFrame implements ActionListener {
    ...
    ViewInformation(String biller) {
        ...
        JLabel heading = new JLabel("View Coustomer Information");
        ...
        lblbillnumber.setBounds(70, 140, 100, 20);
        add(lblbillnumber);
        
        JLabel billnumber  = new JLabel("");
        billnumber.setBounds(250, 140, 100, 20);
        add(billnumber);
